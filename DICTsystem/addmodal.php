                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 section">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="notificationDate" name="date_of_notification" placeholder="mm/dd/yyyy" required>
                                    </div>
                                    <div class="form-group">
                                    <span> <b>Date of Examination</b></span>
                                        <input type="date" class="form-control" id="examDate" name="date_of_examination" placeholder="mm/dd/yyyy" required>
                                    </div>
                                    <div class="form-group">
